...
│                         academia-guard and configuration for tools like black
│
...
│
└── academia-guard   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes academia-guard a Python module
    │
